...
word f_pc = [
	...
	M_icode == IJXX && M_ifun != UNCOND && M_Cnd && (M_valE >= M_valA) : M_valE; # taken, while predicted as not taken
  M_icode == IJXX && M_ifun != UNCOND && !M_Cnd && (M_valE < M_valA) : M_valA; # not taken, while predicted as taken
