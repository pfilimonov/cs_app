...
src/ch7/p713base:     file format elf64-x86-64
...
0000000000001129 <main>:
    ...
    1136:	e8 0a 00 00 00       	call   1145 <swap>
...
0000000000001145 <swap>:
    ...
    115e:	8b 10                	mov    (%rax),%edx
    1160:	8b 0d ae 2e 00 00    	mov    0x2eae(%rip),%ecx        # 4014 <buf+0x4>
    1166:	89 08                	mov    %ecx,(%rax)
    1168:	48 8b 05 b9 2e 00 00 	mov    0x2eb9(%rip),%rax        # 4028 <bufp1>
    116f:	89 10                	mov    %edx,(%rax)
    1171:	c3                   	ret
